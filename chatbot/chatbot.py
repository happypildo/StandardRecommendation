...
class Chatbot:
    def __init__(self):
        self.doc_store = NewsDocumentStore.from_existing("news_documents")
        self.chat_history = []
        self.llm = ChatOpenAI(
    ...
    def search_documents(self, query, k):
        try:
            self.doc_store.similarity_search(query, k)
        except Exception as e:
            return []

    def generate_answer(self, query, relevant_docs, stream_handler):
